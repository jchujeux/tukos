...
;
    ...
    public function trendChartCustomizableAtts($translations, $dateWidgetNames, $selectedDateWidgetName){
        ...
        return [
            ...
            'plots' => Utl::array_merge_recursive_replace(Widgets::simpleDgrid(Widgets::complete(['storeArgs' => ['idProperty' => 'idg'],
            ...
            'kpis' => Utl::array_merge_recursive_replace(Widgets::simpleDgrid(Widgets::complete(['label' => $this->tr('seriesToInclude'), 'storeArgs' => ['idProperty' => 'idg'],
    ...
    public function spiderChartCustomizableAtts($translations, $dateWidgetNames,  $selectedDate){
        ...
        return [
            'chartFilter' => ['att' => 'chartFilter', 'type' => 'TextBox', 'name' => $tr('chartFilter')],
            'kpis' => Utl::array_merge_recursive_replace(Widgets::simpleDgrid(Widgets::complete(['label' => $tr('kpisToInclude'), 'storeArgs' => ['idProperty' => 'idg'],
            ...
            'itemsSets' => Utl::array_merge_recursive_replace(Widgets::simpleDgrid(Widgets::complete(['label' => $tr('itemsSetsToInclude'), 'storeArgs' => ['idProperty' => 'idg'],
    ...
    public function repartitionChartCustomizableAtts($translations, $dateWidgetNames, $selectedDateWidgetName){
        ...
        return [
            ...
            'axes' => Utl::array_merge_recursive_replace(Widgets::simpleDgrid(Widgets::complete(['label' => $this->tr('Axes'), 'storeArgs' => ['idProperty' => 'idg'],
                'tukosTooltip' => ['label' => '', 'onClickLink' => ['label' => $this->tr('help'), 'name' => 'TrendChartAxesTukosTooltip', 'object' => $this->objectName]],
                'colsDescription' => [
                    'rowId' => ['field' => 'rowId', 'label' => 'id', 'width' => 40, 'className' => 'dgrid-header-col', 'hidden' => true],
                    'name' => Widgets::description(Widgets::textBox(['edit' => ['label' => $this->tr('Name'), 'style' => ['width' => '5em']], 'storeedit' => ['width' => 60]]), false),
