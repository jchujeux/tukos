        ...
        $this->dataWidgets = [
            'id' => ViewUtils::textBox($this, 'Id', [
                    'atts' => [
                        ...
                        'storeedit' => ['width' => Widgets::$mediumWidth, 'minWidth' => Widgets::$smallWidth, 'maxWidth' => Widgets::$mediumWidth,'renderExpando' => true, 'formatter' => 'formatId', 'renderCell' => '', 'editOn' => 'dblClick'],
                        'overview'  => ['width' => Widgets::$smallWidth, 'minWidth' => Widgets::$smallWidth, 'maxWidth' => Widgets::$mediumWidth],
                    ]
                ]
            ), 
