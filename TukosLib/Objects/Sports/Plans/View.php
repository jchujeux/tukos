	...
	function __construct($objectName, $translator=null){
		...
		$subObjects = [
			...
			/*'warmup' => [
				...
				'atts' => ['title' => $this->tr('warmuptemplates'), 'dndParams' => [ 'copyOnly' => true, 'selfAccept' => false], 'hidden' => true],
				'filters' => ['stagetype' => 'warmup'],
				 'allDescendants' => true,
			],
			'mainactivity' => [
				'object' => 'sptworkoutsstages',
				'atts' => ['title' => $this->tr('mainactivitytemplates'),  'dndParams' => [ 'copyOnly' => true, 'selfAccept' => false], 'hidden' => true],
				'filters' => ['stagetype' => 'mainactivity'],
				'allDescendants' => 'true'
			],
			'warmdown' => [
				'object' => 'sptworkoutsstages',
				'atts' => ['title' => $this->tr('warmdowntemplates'),  'dndParams' => [ 'copyOnly' => true, 'selfAccept' => false], 'hidden' => true],
...
var tsbCalculator = this.tsbCalculator, iterator = tsbCalculator.workoutsIterator, previousItem, hasPerformedDeleted = false, hasPlannedDeleted = false;
