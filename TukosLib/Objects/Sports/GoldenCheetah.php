...
class GoldenCheetah {
    ...
    public static function init(){
        self::$widgets = [
            ...
            'gcavghr' => ['gcName' => 'Average_Heart_Rate', 'description' => ['sessions' => ['colType' => 'VARCHAR(10) DEFAULT NULL', 'widgetType' => 'numberTextBox'], 'gcCols' => self::numberFormat]],
            'gc95hr' => ['gcName' => '95%_Heartrate', 'description' => ['sessions' => ['colType' => 'VARCHAR(10) DEFAULT NULL', 'widgetType' => 'numberTextBox'], 'gcCols' => self::numberFormat]], 
            'gctrimp100' => ['gcName' => 'TRIMP(100)_Points', 'description' => ['sessions' => ['colType' => 'VARCHAR(10) DEFAULT NULL', 'widgetType' => 'numberTextBox'], 'gcCols' => self::numberFormat]],
