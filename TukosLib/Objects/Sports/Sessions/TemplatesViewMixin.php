...
trait TemplatesViewMixin {
	...
	public function filterWidgets(){
        return [
            'level1filter'    => ViewUtils::storeSelect('level1', $this, 'Level1', null, ['atts' => ['edit' => [
            	'onChangeLocalAction' => [
            ...
            'level2filter'    => ViewUtils::storeSelect('level2', $this, 'Level2', null, ['atts' => ['edit' => [
            ...
            'level3filter'    => ViewUtils::storeSelect('level3', $this, 'Level3', null, ['atts' => ['edit' => [
            	'dropdownFilters' => ['level1' => '@level1filter'],
            	'onChangeLocalAction' => [
            		'exercisestemplates' => ['collection' => 
            			"var level1 = tWidget.form.valueOf('level1'), filters = level1 ? [['eq', 'level1', newValue]] : [];" .
