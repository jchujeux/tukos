...
*/
            ...
            //'quantityperregion'   => ['type' => 'spiderChart', 'atts' => ['edit' => ['title' => $this->tr('Quantities per region')  , 'showTable' => 'yes', 'tableAtts' => $this->tableAtts('region'), 'series' => ['thePlot' => ['value' => ['value' => 'qty', 'key' => 'region'], 'options' => ['fill' => "blue"]]],
            //    'axes' => ['Alentejo' => ['type' => 'Base', 'min' => 0, 'max' => 2], 'Alsace' => ['type' => 'Base', 'min' => 0, 'max' => 20], 'Aragon' => ['type' => 'Base', 'min' => 0, 'max' => 2], 'Bordeaux' => ['type' => 'Base', 'min' => 0, 'max' => 250]]]]],
