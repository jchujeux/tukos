...
class View extends AbstractView {
	...
	function __construct($objectName, $translator=null){
        ...
        $customDataWidgets = [
                ...
                'painnextday' => ViewUtils::storeSelect('pain', $this, 'Painnextday', [true, 'ucfirst', true, false], ['atts' => ['edit' => ['backgroundColors' => Physio::$painColors, 'style' => ['width' => '100%', 'maxWidth' => '30em']]]]),
