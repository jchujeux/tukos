...
class View extends AbstractView {
    ...
    function __construct($objectName, $translator=null){
        ...
        $customDataWidgets = [//, ['atts' => ['edit' => ['dndParams' => ['accept' => ['dgrid-row']], 'onDropMap' => ['column' => 'comments']]]]
			...
			'clubyesorno'  => ViewUtils::storeSelect('yesOrNo', $this, 'Clubyesorno', null, ['atts' => ['edit' => ['style' => ['maxWidth' => '10em']]]]),
        	...
        	'paindailyyesorno' => ViewUtils::storeSelect('yesOrNo', $this, 'Paindailyyesorno', null, ['atts' => ['edit' => ['widgetCellStyle' => ['width' => '6em']]]]),
        	'recentchanges' =>  ViewUtils::textArea($this, 'RecentChanges'),
        	'orthosolesyesorno'  => ViewUtils::storeSelect('yesOrNo', $this, 'Orthosolesyesorno', null, ['atts' => ['edit' => ['widgetCellStyle' => ['width' => '6em']]]]),
        	'orthosolessince' =>  ViewUtils::textArea($this, 'Orthosolessince'),
        	'orthosoleseaseyesorno' => ViewUtils::storeSelect('yesOrNo', $this, 'Orthosoleseaseyesorno', null, ['atts' => ['edit' => ['widgetCellStyle' => ['width' => '6em']]]]),
			...
			'breakfastyesorno' => ViewUtils::storeSelect('yesOrNo', $this, 'Breakfastyesorno', null, ['atts' => ['edit' => ['widgetCellStyle' => ['width' => '6em']]]]),
