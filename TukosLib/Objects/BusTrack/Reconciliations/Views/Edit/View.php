...
use TukosLib\Objects\BusTrack\Reconciliations\Views\Edit\ViewActionStrings as VAS;
...
class View extends EditView{
    ...
    function __construct($actionController){
        ...
        $this->dataLayout['contents']['row1'] = [
            'tableAtts' => ['cols' => 2, 'customClass' => 'labelsAndValues', 'showLabels' => false, 'widgetWidths' => ['40%', '60%']],
            'contents' => [
                'col1' => [
        ...
        $this->actionWidgets['synchronize'] =  ['type' => 'TukosButton', 'atts' => ['label' => $this->view->tr('synchronize'), 'onClickAction' => VAS::syncOnClickAction()]];
    }
}
?>
