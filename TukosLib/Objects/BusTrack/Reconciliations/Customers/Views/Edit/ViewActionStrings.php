...
EOT;
	...
	if (paymentsToSync.length > 0){
        ...
        Pmg.serverDialog({action: 'Process', object: "bustrackreconciliations{$customersOrSuppliers}", view: 'edit', query: {id: form.valueOf('id'), startdate: form.valueOf('startdate'), enddate: form.valueOf('enddate'),
