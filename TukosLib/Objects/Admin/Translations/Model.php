...
class Model extends ObjectTranslator {
    ...
    function __construct($objectName, $translator=null){
        ...
        $this->setNameOptions = array_unique(array_merge(['TukosApp', 'TukosSports', 'TukosBus', 'TukosBlog', 'JCHBlog', 'TukosMSQR', 'TukosWoundTrack', 'tukosLib', 'countrycodes', 'glossary'], Directory::getDomains(), Directory::getObjs(), ['page', 'common']));
