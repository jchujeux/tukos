       ...
       parent::__construct($actionController);
        ...
        $this->dataLayout   = [
            ...
            'contents' => [
            	...
            	'row2' => [
                    'tableAtts' => ['cols' => 3, 'customClass' => 'labelsAndValues', 'showLabels' => true, 'orientation' => 'vert', 'spacing' => '0', 'widgetWidths' => ['30%', '40%', '30%']],      
                    'contents' => [              
                        'col1' => ['tableAtts' => ['cols' => 1, 'customClass' => 'labelsAndValues', 'showLabels' => true, 'orientation' => 'vert'], 'widgets' => ['loadchart', 'comments', 'worksheet']],
            ...
            'paneDescription' => [
                ...
                'onOpenAction' => 
                    ...
                    "return when(this.setWidgets({value: {" .
                        ...
                        "content: ' ' " .
                    "}}), function(){" .
                        //"console.log('will call serveraction');" .
