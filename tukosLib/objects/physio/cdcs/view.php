...
class View extends AbstractView {
    ...
    function __construct($objectName, $translator=null){
        ...
        $customDataWidgets = [//, ['atts' => ['edit' => ['dndParams' => ['accept' => ['dgrid-row']], 'onDropMap' => ['column' => 'comments']]]]
            ...
            'sex'        => ViewUtils::storeSelect('sex', $this, 'Sex', ['atts' => ['edit' => ['disabled' => true]]]),
            ...
            'morphotype' => ViewUtils::storeSelect('morphotype', $this, 'Morphotype', ['atts' => ['edit' => ['disabled' => true, 'style' => ['width' => '10em']]]]),
			...
			'clubyesorno'  => ViewUtils::storeSelect('yesOrNo', $this, 'Clubyesorno', ['atts' => ['edit' => ['style' => ['maxWidth' => '10em']]]]),
        	...
        	'paindailyyesorno' => ViewUtils::storeSelect('yesOrNo', $this, 'Paindailyyesorno', ['atts' => ['edit' => ['widgetCellStyle' => ['width' => '6em']]]]),
        	'recentchanges' =>  ViewUtils::textArea($this, 'RecentChanges'),
        	'orthosolesyesorno'  => ViewUtils::storeSelect('yesOrNo', $this, 'Orthosolesyesorno', ['atts' => ['edit' => ['widgetCellStyle' => ['width' => '6em']]]]),
        	'orthosolessince' =>  ViewUtils::textArea($this, 'Orthosolessince'),
        	'orthosoleseaseyesorno' => ViewUtils::storeSelect('yesOrNo', $this, 'Orthosoleseaseyesorno', ['atts' => ['edit' => ['widgetCellStyle' => ['width' => '6em']]]]),
			...
			'breakfastyesorno' => ViewUtils::storeSelect('yesOrNo', $this, 'Breakfastyesorno', ['atts' => ['edit' => ['widgetCellStyle' => ['width' => '6em']]]]),
