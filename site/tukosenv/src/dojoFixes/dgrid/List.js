	...
	var List = declare(null, {
		...
		set: function (/*String*/ name, /*Object*/ value /*, ... */) {
			...
			if (typeof name === 'object') {
				...
				else if (typeof this[fn + 'Attr'] === 'function') {//JCH: fix to make this compatible with dijit setters (needed in _WidgetsExtend)
					this[fn + 'Attr'].apply(this, [].slice.call(arguments, 1));
				}else{
					this[name] = value;
				}
			}
