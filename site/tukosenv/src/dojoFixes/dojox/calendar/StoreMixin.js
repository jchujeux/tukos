/*
 * Modified for tukos so as to support date and time in diffrent dojo store properties
 */
define(["dojo/_base/declare", "dojo/_base/array", "dojo/_base/html", "dojo/_base/lang", "dojo/dom-class",
    ...
    return declare(Stateful, {
        ...
        itemToRenderItem: function(item, store){
            ...
            if (this.storeToCalendarItem){
                var renderItem = this.storeToCalendarItem(item, store);
                renderItem.cssClass = this.cssClassFunc ? this.cssClassFunc(item) : null;
                return renderItem;
            }else{
                 return {
        ...
        renderItemToItem: function(/*Object*/ renderItem, /*dojo.store.api.Store*/ store){
            ...
            if (this.storeToCalendarItem){
                var item =  this.calendarToStoreItem(renderItem, store);
             }else{           
                var item = {};
