define([
	...
	"dojoFixes/dojox/editor/plugins/TablePlugins"
], function(dojo, dijit, dojox, _Plugin, TablePlugins) {
    ...
    _Plugin.registry["resizeTableColumn"] = function(args){
        return new ResizeTableColumn(args);
    };
