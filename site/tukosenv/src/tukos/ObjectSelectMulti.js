        ...
        openDropDown: function(){
            ...
            if (!this.dropDown){
                ...
                if (self.items){
                	...
                	Pmg.serverDialog({action: 'getObjectModules', view: 'noview', object: this.form.object, query: {contextpathid: this.form.tabContextId(), contextid: self.form.valueOf('id')}}, [], [], messages.actionDone).then(
	                	function(response){
