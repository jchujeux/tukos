define (["dojo/_base/declare", "dojo/_base/lang", "dojo/dom-construct", "dojo/dom-style", "dijit/_WidgetBase", "dojox/mobile/Slider", "dojo/store/Memory", "tukos/widgetUtils"], 
    ...
    return declare([_WidgetBase], {
        ...
        postCreate: function(args){
        	...
        	var ratings = this.storeArgs.data.slice(2), initialValue = this.storeArgs.data[1].id, min = ratings.reduce(function(a, b){
        ...
        _setValueAttr: function(value){
        	...
        	this.descriptionNode.innerHTML = this.store.get(value);
        },
