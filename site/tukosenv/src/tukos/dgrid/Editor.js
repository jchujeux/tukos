define([
	...
	return declare(null, {
		...
		hasEditorInstance: function(colId){
			return this._editorInstancesColumns[colId];
		},
		...
		refresh: function () {
			var editorInstances = this.getEditorInstances();
			for (var id in editorInstances) {
				var editorInstanceDomNode = editorInstances[id].domNode;
