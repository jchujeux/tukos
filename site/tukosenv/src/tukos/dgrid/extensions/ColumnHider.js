define([
	...
	'dgrid/util/misc',
	'tukos/PageManager',
	'dojo/i18n!dgrid/extensions/nls/columnHider'
], function (arrayUtil, declare, domConstruct, has, listen, miscUtil, Pmg, i18n) {
/*
		...
		renderHeader: function () {
			...
			if (!hiderMenuNode) {
				...
				hiderToggleNode = this.hiderToggleNode = domConstruct.create('div', {
					...
					role: 'button',
					tabindex: 0,
					style: Pmg.isRestrictedUser() ? "display:none;" : (Pmg.isMobile() ? "transform:scale(2);right:4px;top:4px;" : "")
				}, this.domNode);
