define([
	...
	'tukos/utils',
	'dojo/_base/html'
], function (declare, arrayUtil, listen, query, lang, dom, domConstruct, geom, has, miscUtil, utils) {
	...
	return declare(null, {
		...
		setInitialColsWidth: function(){
			var columnSizes = this._columnSizes, colNodes, colWidths;
			if (!this._resizedColumns) {
				...
				colNodes.forEach(function (colNode, i) {
					resizeColumnWidth(this, colNode.columnId, Math.max(colWidths[i], this.columns[colNode.columnId].minWidth || this.minWidth), null, false);
				}, this);
