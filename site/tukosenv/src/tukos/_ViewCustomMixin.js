define (["dojo/_base/array", "dojo/_base/declare", "dojo/_base/lang", "dojo/dom-construct", "dojo/on", "dojo/ready", "dijit/registry", "dijit/popup", 
         "dijit/form/Button", "dijit/form/RadioButton", "dijit/form/TextBox", "dojo/request", "dojo/when", "tukos/utils", "tukos/hiutils", "tukos/TukosTooltipDialog", "tukos/ObjectSelect", 
         "tukos/PageManager", "dojo/i18n!tukos/nls/messages", "dojo/domReady!"], 
    function(arrayUtil, declare, lang, dct, on, ready, registry, popup, Button, RadioButton, TextBox, request, when, utils, hiutils, TukosTooltipDialog, ObjectSelect, Pmg, messages){
    return declare(null, {
