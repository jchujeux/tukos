define (["dojo/_base/declare", "dojo/_base/lang", "dojo/on", "dojo/promise/all", "dojo/ready", "dojo/when", "dijit/focus", "tukos/utils", "tukos/hiutils", "tukos/TukosTooltipDialog", "tukos/Download",  "tukos/PageManager", "dojo/i18n!tukos/nls/messages", "dojo/domReady!"], 
    ...
    return declare(TukosTooltipDialog, {
        ...
        sendAsWatchAction: function(sWidget, tWidget, newValue){
            ...
            ['filename', 'orientation', 'smartshrinking', 'zoom', 'headerfooter', 'coverpage'].forEach(function(name){
        ...
        sendEmail: function(){ 
            setTimeout(lang.hitch(this, function(){
	            ...
	            lang.hitch(this, this.dataToProcess)().then(function(data){
	            	...
	            	Pmg.serverDialog(lang.hitch(form, form.completeUrlArgs)({action: 'Process', query: {id: true, params: {process: 'sendContent', noget:  true}}}), {data: data, timeout: Pmg.getCustom('defaultClientTimeout', 32000)},{widget: widget, att: 'label'});
	            });
            }), 100);
        },
        saveFile: function(){ 
