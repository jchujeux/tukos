        ...
        sendEmail: function(){ 
            setTimeout(lang.hitch(this, function(){
	            ...
	            lang.hitch(this, this.dataToProcess)().then(function(data){
	            	...
	            	Pmg.serverDialog(lang.hitch(form, form.completeUrlArgs)({action: 'Process', query: {id: true, params: {process: 'sendContent', noget:  true}}}), {data: data, timeout: Pmg.getCustom('defaultClientTimeout')},{widget: widget, att: 'label'});
	            });
            }), 100);
        },
        saveFile: function(){ 
