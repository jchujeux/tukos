"use strict";
define(["dojo/_base/declare", "tukos/objects/modeling/rheologies/diffusion/hydraulics/pressure/isotropic/Linear", "tukos/objects/modeling/modeling", "tukos/utils", "tukos/maths/matrices"], 
function(declare, LinearIsotropic, modeling, utils, matrices){
	const g = modeling.constants.g;
	return declare([LinearIsotropic], {
		/*
		* If pressure < pressureThreshold, conductivityCorrection is applied.
		*/
