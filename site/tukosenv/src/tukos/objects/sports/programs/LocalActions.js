    ...
    return declare(null, {
		...
		synchronizeWithStrava: function(pane){
			...
			if (contentMessage){
            	...
            	Pmg.setFeedback(Pmg.message('actionDoing'));
            	this.form.serverDialog({action:'Process', query: {id: programId, parentid: athleteid, synchrostart: pane.valueOf('stsynchrostart'), synchroend: pane.valueOf('stsynchroend'), synchrostreams: pane.valueOf('synchrostreams'), ignoresessionflag: pane.valueOf('ignoresessionflag'), 
