define (["dojo/_base/declare", "dojo/_base/lang", "dojo/on", "dojo/ready", "dojo/string", "dijit/registry", "tukos/utils", "tukos/PageManager"], 
function(declare, lang, on, ready, string, registry, utils, Pmg){
    var toProcess;
	return declare(null, {
        postCreate: function(){
            ...
            on(this, "click", function(evt){
                ...
                if (action === 'Search'){
                    ...
                    Pmg.alert({title: Pmg.message('noRowToProcessNoAction') + toProcess.warning, content: ''});                                 
                }else{
                    if (action === 'Modify'){
                        ...
                        Pmg.confirm({title: Pmg.message('overview'+action) + toProcess.ids.length + Pmg.message('entries') + toProcess.warning, content: Pmg.message('sureWantToContinue')}).then(
                            function(){
                            	if(action === "Process" && (queryParams || {}).process === "exportItems"){
                                	...
                                	require(["tukos/Download", function(download){
        ...
        searchAction: function(data){
            ...
            Pmg.setFeedback(Pmg.messaghe('actionDone'));
        },
