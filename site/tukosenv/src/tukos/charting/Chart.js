define(["dojox/main", "dojo/_base/lang", "dojo/_base/array","dojo/_base/declare", "dojo/dom-style",
	...
	"dojox/charting/Element", "dojox/charting/SimpleTheme", "dojox/charting/Series", "dojox/charting/axis2d/common", "dojox/charting/plot2d/common", "dojox/gfx/shape",
	...
	var Chart = declare(has("dojo-bidi")? "dojox.charting.NonBidiChart" : "dojox.charting.Chart", null, {
		...
		removePlot: function(name){
			...
			if(name in this.plots){
				...
				// destroy the plot
				this.stack[index].destroyRecursive ? this.stack[index].destroyRecursive() : this.stack[index].destroy();
