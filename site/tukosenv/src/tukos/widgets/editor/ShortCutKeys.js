 ...
 */
define (["dojo/_base/declare", "dojo/_base/lang", "dojo/keys", "dojo/sniff", "dojo/dom-style"], 
function(declare, lang, keys, has, domStyle){
    var cache = {}; 
	...
	return declare(null, {
    	...
    	addShortCutKeys: function(){
            ...
            this.addKeyHandler('v', false, false, lang.hitch(this, this.pasteCache), true);
		}, 
