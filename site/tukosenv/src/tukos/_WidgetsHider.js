    ...
    return declare(TooltipDialog, {
        ...
        toggleWidgetHideMode: function(change){
            ...
            if (widget.layoutContainer){
                ...
                if (widget.disabled && widget.widgetType === 'Textarea'){
            ...
            lang.setObject('customization.widgetsDescription.' + (widget.form.widgetsHiderArgs && widget.form.widgetsHiderArgs.dialogPath || '') + widget.widgetName + '.atts.hidden', widget.hidden, widget.form.form || widget.form);
        }
    });
}); 
