...
<div>
  ...
  <table border="1" cellpadding="0" cellspacing="0" class="tukosWorksheet" id="simulations" style="table-layout: fixed; width: 100%;">
    <tbody>
      ...
      <tr>
        <td contenteditable="false" id="tdid22_1542197008999" style="background-color: lightgrey; font-weight: bold; text-align: center;">2</td><td id="tdid23_1542197008999" onclick="tukos.onTdClick(this);" ondblclick="tukos.onTdDblClick(this);" style="text-align: center;">
        <div class="tukosExpression" id="e_simulations!A2" onclick="tukos.onExpClick(this);" style="display: inline;" title="simulations!A2">
          <textarea onblur="tukos.onExpBlur(this);" onclick="event.stopPropagation();" style="display: none; height: 18px;">
          </textarea>
