...
class Configure{
    ...
    function __construct(){
        ...
        $this->modulesMenuLayout = array_merge(($request['object'] === 'physiopersotreatments' && $request['view'] === 'Edit' && isset($query['id'])) 
            ? ['@physiogametracks' => ['type' => 'MenuBarItem', 'atts' => ['onClickArgs' => ['object' => 'physiogametracks', 'view' => 'Edit', 'mode' => 'Tab', 'action' => 'Tab', 'query' => ['id' => $queryId]]]]]
            : ['$physiogametracks' => []],
            ['@help' => [
                [/*'overview' => ['type' => 'MenuItem',     'atts' => ['onClickArgs' => ['object' => 'Help', 'view' => 'Overview', 'mode' => 'Tab', 'action' => 'Tab']]],*/
                'guidedtour' => ['type' => 'MenuItem', 'atts' => [
                    'onClickArgs' => ['object' => 'Help', 'view' => 'Edit', 'mode' => 'Tab', 'action' => 'Tab', 'query' => ['storeatts' => json_encode(['where' => ['name' => ['RLIKE', Tfk::tr('GuidedtourWoundTrack')]]])]]]],
                'tutotukos' => ['type' => 'MenuItem', 'atts' => [
                    'onClickArgs' => ['object' => 'Help', 'view' => 'Edit', 'mode' => 'Tab', 'action' => 'Tab', 'query' => ['storeatts' => json_encode(['where' => ['name' => ['RLIKE', Tfk::tr('TutotukosWoundTrack')]]])]]]]
                ]]
            ]);
